...
/**
 * Select — Skyie-native. Sharp ink/30 border, paper bg, ink text.
 * Active item is signal-blue. Sharp menu, no shadows or rounded corners.
 */
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={cn("flex cursor-default items-center justify-center py-1 text-ink/55", className)}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-3 py-1.5 text-mono-sm text-ink/45", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn("my-1 h-px bg-ink/15", className)}
    {...props}
  />
))
